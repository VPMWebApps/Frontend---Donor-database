    ...
    <div className="min-h-screen #FCE7F3 p-10">
      <div className="flex flex-col md:flex-row justify-center gap-8">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 w-full max-w-xs text-center">
          <img src="Frontend/src/assets/vpm-logo.png" alt="Institution" className="w-48 mx-auto mb-4" />
        ...
        {/* Card 2 */}
        <div className="bg-white rounded-xl shadow-lg p-6 w-full max-w-xs text-center">
          <img src="Frontend/src/assets/sdgl_1.png" alt="SDG" className="w-48 mx-auto mb-4" />
